    ...
    if (typeof window !== "undefined") {
      ...
      if (roleString) {
        try {
          ...
          setIsConsumer(
            Array.isArray(roles) && roles.includes("ROLE_CONSUMER")
          );
        } catch (e) {
          ...
          {variant === "planted" && (
            <Stack spacing={2} mt={4} fontSize="sm" color="gray.700">
              ...
              <Text>
                ...
                {estimatedHarvestDate
                  ? new Date(estimatedHarvestDate).toLocaleDateString()
                  : "N/A"}
              </Text>
              <Text>
                <b>Actual Harvest:</b>{" "}
          ...
          {variant === "product" && (
            <Stack spacing={3} mt={4}>
              ...
              >
                {quantity !== undefined && (
                  <Text>
                    <b>Quantity:</b> {quantity} {unit || "units"}
                  </Text>
                )}
              </Stack>
              ...
              <Flex justify="center" align="center" mt={1}>
                {[1, 2, 3, 4, 5].map((i) => (
                  <Box
                    key={i}
                    color={
                      i <= Math.round(rating ?? 0) ? "yellow.400" : "gray.300"
                    }
                  >
                ...
                <Flex align="center" gap={2} justify="center">
                  ...
                  <NumberInput
                    ...
                    onChange={(valueString) =>
                      setSelectedQty(Number(valueString))
                    }
                  >
